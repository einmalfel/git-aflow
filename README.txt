 ...
 * gitwrapper - thin wrapper able to parse git commands output.
 ...
 * gitaflow - gitaflow itself. It depends on both gitconflict and gitwrapper packages.

Documentation resides in gitaflow wiki: github.com/einmalfel/git-aflow/wiki

To install git-aflow from source use pip:
pip3 install gitwrapper_package/ gitconflicts_package/ gitaflow_package/
